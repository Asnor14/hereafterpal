...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      >
        <h1 className="text-3xl font-semibold text-center mb-8">About HereafterPal</h1>
        ...
        <div className="space-y-4 text-light-textSecondary dark:text-dark-textSecondary">
          <p>
            Welcome to HereafterPal. We believe that every life, whether human or animal, is a story worth telling and preserving. In a world that moves quickly, taking a moment to honor and remember those who have passed is more important than ever.
          </p>
          <p>
